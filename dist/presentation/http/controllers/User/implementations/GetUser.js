...
class GetUserController {
    constructor(getAllUserUseCase, httpErrors = new HttpErrors_1.HttpErrors(), httpSuccess = new HttpSuccess_1.HttpSuccess()) {
    ...
    async handle(httpRequest) {
        ...
        if (httpRequest.query && Object.keys(httpRequest.query).length > 0) {
            ...
            if (queryStringParams.includes('page')) {
                ...
                response = await this.getAllUserUseCase.execute(page);
            }
            else {
