...
exports.AuthenticateAdminController = void 0;
...
class AuthenticateAdminController {
    constructor(authenticateAdminUseCase, httpErrors = new HttpErrors_1.HttpErrors(), httpSuccess = new HttpSuccess_1.HttpSuccess()) {
    ...
    async handle(httpRequest) {
        ...
        if (httpRequest.body && Object.keys(httpRequest.body).length > 0) {
            ...
            if (bodyParams.includes('username') && bodyParams.includes('password')) {
                const authenticateAdminDTO = httpRequest.body;
                response =
