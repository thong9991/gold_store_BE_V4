...
exports.GetGoldPriceController = void 0;
...
class GetGoldPriceController {
    constructor(getAllGoldPriceUseCase, httpErrors = new HttpErrors_1.HttpErrors(), httpSuccess = new HttpSuccess_1.HttpSuccess()) {
        this.getAllGoldPriceUseCase = getAllGoldPriceUseCase;
...
exports.GetGoldPriceController = GetGoldPriceController;
