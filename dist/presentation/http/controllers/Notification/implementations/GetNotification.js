...
exports.GetVendorController = void 0;
...
class GetVendorController {
    constructor(getAllVendorUseCase, httpErrors = new HttpErrors_1.HttpErrors(), httpSuccess = new HttpSuccess_1.HttpSuccess()) {
        this.getAllVendorUseCase = getAllVendorUseCase;
