...
class RefreshTokenUserController {
    constructor(refreshTokenUserUseCase, httpErrors = new HttpErrors_1.HttpErrors(), httpSuccess = new HttpSuccess_1.HttpSuccess()) {
    ...
    async handle(httpRequest) {
        ...
        if (httpRequest.body && Object.keys(httpRequest.body).length > 0) {
            ...
            if (bodyParams.includes('refreshTokenId')) {
                const refreshTokenUserDTO = httpRequest.body;
                response =
