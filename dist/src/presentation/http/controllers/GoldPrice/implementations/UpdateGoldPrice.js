...
exports.UpdateGoldPriceController = void 0;
...
class UpdateGoldPriceController {
    constructor(updateGoldPriceUseCase, httpErrors = new HttpErrors_1.HttpErrors(), httpSuccess = new HttpSuccess_1.HttpSuccess()) {
        this.updateGoldPriceUseCase = updateGoldPriceUseCase;
    ...
    async handle(httpRequest) {
        ...
        if (httpRequest.body &&
            ...
            if (pathStringParams.includes('goldType') &&
                ...
                response = await this.updateGoldPriceUseCase.execute(goldType, updateGoldPriceRequestDTO);
            }
            else {
...
exports.UpdateGoldPriceController = UpdateGoldPriceController;
