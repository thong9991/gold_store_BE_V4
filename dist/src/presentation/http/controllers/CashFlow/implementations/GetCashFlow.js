...
exports.GetCashFlowController = void 0;
...
class GetCashFlowController {
    constructor(getAllCashFlowUseCase, httpErrors = new HttpErrors_1.HttpErrors(), httpSuccess = new HttpSuccess_1.HttpSuccess()) {
        this.getAllCashFlowUseCase = getAllCashFlowUseCase;
...
exports.GetCashFlowController = GetCashFlowController;
