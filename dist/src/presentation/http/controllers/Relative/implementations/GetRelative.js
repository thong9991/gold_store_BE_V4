...
exports.GetRelativeController = void 0;
...
class GetRelativeController {
    constructor(getAllRelativeUseCase, httpErrors = new HttpErrors_1.HttpErrors(), httpSuccess = new HttpSuccess_1.HttpSuccess()) {
        this.getAllRelativeUseCase = getAllRelativeUseCase;
...
exports.GetRelativeController = GetRelativeController;
